...
- ランダム10問とカテゴリ別学習
- 回答直後の解説
- 全240問で、選んだ誤答に応じた具体的なfeedback（クイズ開始時に遅延読込み）
- 全240問に難易度・実務価値・topic・公式reference・検証日を付与
- 240個の一意なtopicで学習目標の意味重複を品質検査
- 最小対応幅320pxを含む回答後feedback・次問導線・横overflowの回帰検査
...
- 52問の図解（28件の再生・コピー可能なterminal操作例を含む）
- スマートフォン対応
